...
const replacements = [
  ...
  [/docs\/features\/http-files\.md/g, 'docs/integration/http-file.md'],
  [/docs\/features\/bruno-files\.md/g, 'docs/integration/bruno.md'],
  [/docs\/features\/convertor\.md/g, 'docs/integration/openapi.md'],
  [/docs\/integration\/http-files(?:\/index)?\.md/g, 'docs/integration/http-file.md'],
  [/docs\/integration\/bruno-files(?:\/index)?\.md/g, 'docs/integration/bruno.md'],
  [/docs\/integration\/data-imports\.md/g, 'docs/features/data-imports.md'],
  [/docs\/integration\/convertor(?:\/index)?\.md/g, 'docs/integration/openapi.md'],
  // relative from docs/
  ...
  [/\.\.\/features\/convertor\.md/g, '../integration/openapi.md'],
  [/\.\.\/features\/http-files\.md/g, '../integration/http-file.md'],
  [/\.\.\/features\/bruno-files\.md/g, '../integration/bruno.md'],
  [/\.\.\/integration\/http-files(?:\/index)?\.md/g, '../integration/http-file.md'],
  [/\.\.\/integration\/bruno-files(?:\/index)?\.md/g, '../integration/bruno.md'],
  [/\.\.\/integration\/data-imports\.md/g, '../features/data-imports.md'],
  [/\.\.\/integration\/convertor(?:\/index)?\.md/g, '../integration/openapi.md'],
