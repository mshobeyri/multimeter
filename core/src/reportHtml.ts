...
function buildStepHtml(step: TestStepResult): string {
  ...
  if (step.status === 'passed' && expects.length <= 1 && !hasSimilarity && !hasCount) {
  ...
  if (expects.length > 0) {
    ...
    for (const e of expects) {
      ...
      if ((e.status === 'failed' || typeof e.similarity === 'number' || typeof e.count === 'number') && hasValue(e.actual) && hasValue(e.expected)) {
        ...
        if (typeof e.count === 'number') {
          html += `<br/><span class="expect-got">count: ${escapeHtml(String(e.count))}</span>`;
        }
      }
      html += `</div>\n`;
    }
...
const CSS = `
  ...
  :root {
    ...
    --passed: #3fb950;
    --failed: #f85149;
    --passed-bg: rgba(63, 185, 80, 0.12);
    --failed-bg: rgba(248, 81, 73, 0.12);
    --total-bg: rgba(88, 166, 255, 0.12);
    --duration-bg: rgba(139, 148, 158, 0.12);
    --total-fg: #58a6ff;
    --duration-fg: #8b949e;
  }
  ...
  [data-theme="light"] {
    ...
    --passed: #22863a;
    --failed: #cb2431;
    --passed-bg: rgba(34, 134, 58, 0.1);
    --failed-bg: rgba(203, 36, 49, 0.1);
    --total-bg: rgba(59, 130, 246, 0.1);
    --duration-bg: rgba(107, 114, 128, 0.1);
    --total-fg: #3b82f6;
    --duration-fg: #6b7280;
  }
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  [data-theme="light"] .report-head-left h1 {
  ...
  .summary-box .box-icon svg { width: 22px; height: 22px; }
  .summary-box .box-content { display: flex; flex-direction: column; }
  ...
  .box-failed .box-value { color: var(--failed); }
  .box-total .box-icon { background: var(--total-bg); color: var(--total-fg); }
  .box-total .box-value { color: var(--total-fg); }
...
const ICON_X = `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>`;
const ICON_LIST = `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><line x1="8" y1="9" x2="16" y2="9"></line><line x1="8" y1="13" x2="14" y2="13"></line><line x1="8" y1="17" x2="12" y2="17"></line></svg>`;
  ...
  <script>
    ...
    document.addEventListener('keydown', function(e) {
      ...
      if (key === 'a') {
        ...
        document.execCommand('copy'); e.preventDefault(); e.stopPropagation();
      } else if (key === 'x') {
        document.execCommand('cut'); e.preventDefault(); e.stopPropagation();
      } else if (key === 'v') {
        document.execCommand('paste'); e.preventDefault(); e.stopPropagation();
      } else if (key === 'f') {
        var si = document.getElementById('search-input');
        if (si) { si.focus(); e.preventDefault(); e.stopPropagation(); }
      }
    }, true);
  </script>`;
...
<body>
  <div class="report-header">
    <div class="report-head-left">
      <span class="logo">${MULTIMETER_LOGO_SVG}</span>
      <h1>${suiteName}</h1>
    </div>
    <div class="report-head-right">
      <button class="theme-toggle" id="theme-toggle" aria-label="Toggle theme"></button>
      <input id="search-input" class="search-input" type="search" placeholder="Search tests..." aria-label="Filter tests" />
    </div>
  </div>
  <div class="report-container">
    ...
    <div class="summary-boxes">
      ...
      <div class="summary-box box-duration">
        <div class="box-icon">${ICON_CLOCK}</div>
        <div class="box-content">
...
`;
  ...
  html += `  </div>
  <footer class="report-footer">Powered by <a href="https://marketplace.visualstudio.com/items?itemName=mshobeyri.multimeter" target="_blank" rel="noopener noreferrer">Multimeter</a></footer>
${SCRIPT}
</body>
</html>\n`;
