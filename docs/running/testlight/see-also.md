...
- [API](../files/api/index.md) — define HTTP/WS requests to run from the CLI
- [Test](../files/test/index.md) — define test flows to run from the CLI
- [Environment](../files/env/index.md) — variables and presets (`--env-file`, `--preset`)
- [Doc](../files/doc/index.md) — author doc files for `testlight doc`
- [Suite](../files/suite/index.md) — run suites from the CLI
- [Load Test](../files/loadtest/index.md) — run beta load tests from the CLI
