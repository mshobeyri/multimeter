...
const endpoints: Endpoint[] = [
  ...
  { method: 'GET', path: '/json', description: 'Sample JSON response (pretty-printed)' },
  { method: 'GET', path: '/json-compact', description: 'Same sample JSON, compact body, Content-Type application/json' },
