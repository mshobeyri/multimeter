...
| `docs/files/server/index.md` | Document new features |
| `docs/files/test/index.md` | Document `run` step |
| `docs/files/suite/index.md` | Document servers in suites |
...
- [mock-server.md](../docs/files/server/index.md) — user documentation
- [test-mmt.md](../docs/files/test/index.md) — test file documentation
