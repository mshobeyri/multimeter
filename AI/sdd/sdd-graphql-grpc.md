...
| File | Change |
|------|--------|
| `docs/files/api.md` | Add GraphQL and gRPC sections with syntax and examples |
| `docs/guides/mmt-overview.md` | Update protocol support matrix |
...
10. Add docs section to `docs/files/api.md`
...
- `docs/files/api.md` — Current API syntax documentation
