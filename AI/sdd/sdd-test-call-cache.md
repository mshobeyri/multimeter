...
| Docs / examples | [`docs/files/test/index.md`](../../docs/files/test/index.md); [`examples/intermediate/24_test_call_cache`](../../examples/intermediate/24_test_call_cache) |
...
- User docs: `cache` section in `docs/files/test/index.md` + reference list entry.
