...
| `mmt://profile/testgen` | `docs/guides/testgen-profile-ai.md` |
...
| `docs/running/testlight.md` or new `docs/guides/mcp.md` | User-facing MCP setup docs |
...
- [docs/guides/testgen-profile-ai.md](../../docs/guides/testgen-profile-ai.md) — TestGen profile (MCP resource)
