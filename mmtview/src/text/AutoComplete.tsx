...
export const KeySuggestionsByParent = (monaco: any) => {
    ...
    const reportSuggestions = [
        {
            label: "kind",
            kind: monaco.languages.CompletionItemKind.Property,
            insertText: "kind: functional",
            detail: 'Report kind [functional|load]',
            documentation: 'functional for test/suite runs; load for load-test runs. Reports are usually generated by runs, not hand-authored.',
        },
        {
            label: "name",
            kind: monaco.languages.CompletionItemKind.Property,
            ...
            documentation: 'Source file or run title.',
        },
        {
            label: "overview",
            kind: monaco.languages.CompletionItemKind.Property,
            insertText: "overview:\n\ttimestamp: \n\tduration: \n\tchecks: \n\tpassed: \n\tfailed: \n",
            detail: 'Run summary [object]',
            documentation: 'Timing and aggregate counts. Load reports add iterations, throughput, and related metrics here.',
        },
        {
            label: "checks",
            kind: monaco.languages.CompletionItemKind.Property,
            insertText: "checks:\n\t- name: \n\t  type: test\n\t  result: passed\n\t  checks:\n\t    - name: \n\t      type: check\n\t      result: passed\n",
            detail: 'Suite and test entries [array]',
            documentation: 'Functional reports list suite/test rows here. Step results are nested under each test row in checks — there is no root steps field.',
        },
        {
            label: "cancelled",
            kind: monaco.languages.CompletionItemKind.Property,
    ...
    const stepsSuggestions = [
        ...
        },
        {
            ...
            documentation: [
                ...
                'Supported operators: ' + operatorListText(),
    ...
    const envCaClientSuggestions = [
        ...
        },
        {
            ...
            documentation: 'Path to the client certificate file (.pem, .crt, .cer). Use with key. Do not set pfx on the same client.',
        },
        {
            label: "key",
            kind: monaco.languages.CompletionItemKind.Property,
            ...
            documentation: 'Path to the private key file (.key, .pem). Use with cert. Do not set pfx on the same client.',
        },
        {
            label: "pfx",
            kind: monaco.languages.CompletionItemKind.Property,
            ...
            documentation: 'Path to PKCS#12 bundle file (.pfx, .p12). Alternative to cert+key; do not set cert or key on the same client.',
        },
        {
            ...
            documentation: 'Plain text passphrase for encrypted private key. Alternative to passphrase_env; do not set both. Avoid committing to version control.',
        },
        {
            ...
            documentation: 'Name of environment variable containing the passphrase. Alternative to passphrase_plain; do not set both.\nExample: passphrase_env: MY_CERT_PASS',
        },
    ];
    ...
    const formatValueSuggestion = [
        {
            ...
            documentation: 'Send the request without a body. Same as Postman none.\nExample:\nformat: none',
            sortText: '0none',
        },
        {
            label: "json",
        ...
        },
        {
            ...
            insertText: " html",
            detail: 'HTML body',
            documentation: 'Raw HTML body with HTML highlighting.\nDefault Content-Type: text/html.\nExample:\nformat: html\nbody: |\n  <html><body>hello</body></html>',
            sortText: '1html',
        },
        {
            label: "urlencoded",
    ...
    const operatorValueSuggestions = buildOperatorSuggestions('quoted').map(item => ({
        ...item,
    ...
    const expectValueOperatorSuggestions = buildOperatorSuggestions('inline').map(item => ({
        ...item,
        kind: monaco.languages.CompletionItemKind.Operator,
    }));
    ...
    const callSiblings = [
        ...
        { label: 'expect', kind: monaco.languages.CompletionItemKind.Property, insertText: 'expect:\n\t', detail: 'Soft output validation (continue on fail)', documentation: 'Map of output field names to expected values (non-throwing).\nDefault operator is ==.\nExamples:\n- call: login\n  expect:\n    status_code: 200\n    token: != null\n\nWith explicit operator:\n  expect:\n    status_code: == 200\n\nMultiple checks on same field:\n  expect:\n    status_code:\n      - == 200\n      - != 500' },
        { label: 'require', kind: monaco.languages.CompletionItemKind.Property, insertText: 'require:\n\t', detail: 'Hard output validation (stop on fail)', documentation: 'Same map shape as expect, but failures stop the test (like assert).\nExpect and require share one report box; soft fails continue, hard fails stop.\nExample:\n- call: login\n  expect:\n    status_code: 200\n  require:\n    token: != null' },
        ...
        { label: 'report', kind: monaco.languages.CompletionItemKind.Property, insertText: 'report: ', detail: 'Report level', documentation: 'Controls when expect/require results are reported.\nValues: all, fails, none\nOr object form:\n  report:\n    internal: all\n    external: fails' },
    ];
    const httpSiblings = [
        ...
        { label: 'expect', kind: monaco.languages.CompletionItemKind.Property, insertText: 'expect:\n\t', detail: 'Soft response validation (continue on fail)', documentation: 'Map of response fields to expected values (non-throwing).\nExample:\nexpect:\n  status: 200\n  body.ok: true' },
        { label: 'require', kind: monaco.languages.CompletionItemKind.Property, insertText: 'require:\n\t', detail: 'Hard response validation (stop on fail)', documentation: 'Same map shape as expect, but failures stop the test.\nExample:\nrequire:\n  status: 200' },
