...
- **Monorepo layout**:
  ...
  - `AI/`: internal AI-assisted development artifacts. Not shipped to users.
    ...
    - `marketing/`: LinkedIn, YouTube, Hacker News / Show HN skills and drafts. Not part of the published Cursor plugin.
...
Ask for the exact version. Do not invent one.
