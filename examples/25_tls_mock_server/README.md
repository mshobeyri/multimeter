...
```sh
npx testlight run examples/25_tls_mock_server/test/secure_health_test.mmt
```

The runner discovers the nearest `env.mmt` automatically. You can still pass `--env-file examples/25_tls_mock_server/env.mmt` explicitly if you prefer.
