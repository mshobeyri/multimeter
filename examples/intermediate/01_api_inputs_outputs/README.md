...
```sh
npx testlight run examples/intermediate/01_api_inputs_outputs/get_with_outputs.mmt
npx testlight run examples/intermediate/01_api_inputs_outputs/post_with_inputs_outputs.mmt
```
...
See [API docs](../../../docs/files/api.md#inputs) and [API docs — outputs](../../../docs/files/api.md#outputs) for full details.
